...
func TestItemMetadata(t *testing.T) {
	project, err := aep.Open("data/Item-01.aep")
	if err != nil {
		t.Fatal(err)
	}
	...
	expect(t, comp02.ItemType, aep.ItemTypeComposition)
	...
	expect(t, placeholderFootage.ItemType, aep.ItemTypeFootage)
	...
	expect(t, redSolid.FootageType, aep.FootageTypeSolid)
